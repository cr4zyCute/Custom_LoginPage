...
('Healthcare Green', 'corporate', 'centered', '{"colors": {"primary": "#059669", "secondary": "#10b981", "accent": "#3b82f6", "background": "#f0fdf4", "text": "#064e3b"}, "typography": {"fontFamily": "Inter"}, "components": {"borderRadius": {"lg": "0.75rem"}, "shadows": {"md": "0 4px 6px -1px rgba(0,a 0, 0, 0.1)"}}}'),
